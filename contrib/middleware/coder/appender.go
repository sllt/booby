...
func (ap *Appender) Encode(client *booby.Client, msg *booby.Message) *booby.Message {
...
func (ap *Appender) Decode(client *booby.Client, msg *booby.Message) *booby.Message {
