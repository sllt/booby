...
type ServiceManager interface {
	...
	ClientBy(serviceName string) (*booby.Client, error)
}
...
func (list *serviceNodeList) next() (*booby.Client, error) {
	list.mux.RLock()
...
func (s *serviceManager) ClientBy(serviceName string) (*booby.Client, error) {
	s.mux.RLock()
	defer s.mux.RUnlock()
